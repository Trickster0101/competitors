...
$competitor_id = $_SESSION["competitors_id"];

$query = "SELECT * FROM branches b, competitors c where c.competitors_id = '$_SESSION[competitors_id]' && b.is_active = 1 && c.is_active = 1 && b.competitor_id = c.competitors_id";
